...
public class VariableUtils {
     ...
     * @since 1.0
     */
    public static List<Variable> FVars(com.uni.se.jocl.expressions.Expression src) {
        ArrayList<Variable> fVars = new ArrayList<Variable>();

        return FVarsAux(src, fVars);
    }

    private static List<Variable> FVarsAux(com.uni.se.jocl.expressions.Expression src,
            List<Variable> fVars) {
     ...
     * @since 1.0
     */
    public static List<Variable> SVars(com.uni.se.jocl.expressions.Expression ePrime) {
        ...
        for (Variable var : FVars) {
            com.uni.se.jocl.expressions.Expression srcVarExpression = var.getSource();
